...
INSERT INTO `events` VALUES (1,35,'NHL','2020-02-16'),(2,35,'EPL','2020-02-16');
...
INSERT INTO `games` VALUES (1,35,1,'Columbus Blue Jackets','Buffalo Sabres','22:35',NULL,NULL,NULL,NULL),(2,35,1,'Los Angeles Kings','Columbus Blue Jackets','22:10',NULL,NULL,NULL,NULL),(3,35,1,'Boston Bruins','Anaheim Ducks','22:04',NULL,NULL,NULL,NULL),(4,35,1,'Los Angeles Kings','Columbus Blue Jackets','22:10',NULL,NULL,NULL,NULL),(5,35,2,'Liverpool','Watford','23:04',NULL,NULL,NULL,NULL),(6,35,1,'Arizona Coyotes','Boston Bruins','22:14',NULL,NULL,NULL,NULL),(7,35,2,'Newcastle United','Bournemouth','22:02',NULL,NULL,'2020-02-16T22:07:41.577Z',NULL);
...
CREATE TABLE `incidents` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_user` (`user`),
  CONSTRAINT `fk_incident_user` FOREIGN KEY (`user`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `progress` VALUES (1,1,0),(2,2,0),(3,3,0),(4,4,0),(5,5,0),(6,6,0),(7,7,1);
...
-- Dump completed on 2020-02-16 20:26:39
