...
/* Post Season */
INSERT INTO `teams` ( `name`, `icon`, `league` ) 
        VALUES ("Buffalo Bills","bills.png",2),
            ("Miami Dolphins","dolphins.png",2),
            ("New England Patriots","patriots.png",2),
            ("New York Jets","jets.png",2),
            ("Baltimore Ravens","ravens.png",2),
            ("Detroit Lions","lions.png",2),
            ("Green Bay Packers","packers.png",2),
            ("Minnesota Vikings","vikings.png",2),
            ("Atlanta Falcons","falcons.png",2),
            ("Carolina Panthers","panthers.png",2),
            ("New Orleans Saints","saints.png",2),
            ("Tampa Bay Buccaneers","buccaneers.png",2),
            ("Arizona Cardinals","cardinals.png",2),
            ("Los Angeles Rams","rams.png",2),
            ("San Francisco 49ers","49ers.png",2),
            ("Seattle Seahawks","seahawks.png",2)
